...
function mapSemanticReason(reason: Exclude<UsaEnrichmentDecision['reason'], null>) {
  switch (reason) {
    ...
    case 'NORMALIZATION_TIMEOUT':
      return 'NORMALIZATION_TIMEOUT' as const;
    case 'NORMALIZATION_MODEL_ERROR':
      return 'NORMALIZATION_MODEL_ERROR' as const;
    case 'NORMALIZATION_INVALID_OUTPUT':
      return 'NORMALIZATION_INVALID_OUTPUT' as const;
