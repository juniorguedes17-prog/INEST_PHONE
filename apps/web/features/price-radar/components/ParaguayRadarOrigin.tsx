                        ...
                        <div key={key} className="rounded-lg border border-inest-line p-3">
                          <dt className="text-inest-muted">
                            {key === 'productPriceUsd'
                              ...
                              : key === 'usdBrlQuote'
                                ? 'Cotação USD/BRL'
                                : key === 'shippingWeightLbs'
                                  ? 'Peso do Frete (lb)'
                                  : key === 'chargedLbs'
                                    ? 'Libras Cobradas'
                                    : key === 'firstLbUsd'
                                      ? 'Custo do Primeiro lb (USD)'
                                      : key === 'additionalLbUsd'
                                        ? 'Custo por lb Adicional (USD)'
                                        : key === 'quantity'
                                          ? 'Quantidade'
                                          : key === 'weightKg'
                                            ? 'Peso do Frete (kg)'
                                            : key === 'halfKgBlocks'
                                              ...
                                              : key === 'baseShippingUsd'
                                                ...
                                                : key === 'shippingDiscountPercent'
                                                  ? 'Desconto no Frete (%)'
                                                  : key === 'shippingDiscountUsd'
...
export function buildTemporaryPricingRequest(
  ...
  return {
    ...
    model: product.model,
    capacity: product.capacity,
    ram: calculation.normalizedPricing.ram,
    chip: calculation.normalizedPricing.chip,
    screenSize: calculation.normalizedPricing.screenSize,
    connectivity: calculation.normalizedPricing.connectivity,
    color: product.color,
